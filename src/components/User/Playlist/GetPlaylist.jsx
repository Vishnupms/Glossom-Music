...
import { addSongToPlaylist, getPlaylist, getViewPlaylist } from "../../../Api/Api";
    ...
    <Layout>
      ...
      <div className="w-full flex flex-col">
        ...
        <div className="mt-4 flex flex-col gap-1">
          ...
          <div className={`w-full flex flex-row items-center hover:bg-[#4c426e] ${song?.title ? 'bg-[#4c426e]' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>z
          <div className="flex-1 flex flex-row justify-between items-center">
            <img className="w-16 h-16 rounded-full" src={song?.imgURL} alt={song?.title} />
